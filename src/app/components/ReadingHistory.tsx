      ...
      {!hideCalendar && (
        <div className="mb-4 flex flex-wrap items-center gap-2 text-sm">
          ...
          >
            ...
            <span className={cn("text-xs text-muted-foreground whitespace-nowrap", filter === 'partial' && "text-foreground font-semibold")}>일부 완료</span>
          </button>
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2 py-1 rounded-lg border border-transparent hover:bg-muted bg-muted/30 transition-all shrink-0"
          >
            <div className="w-4 h-4 border border-primary rounded bg-primary/10" />
            <span className="text-xs text-muted-foreground whitespace-nowrap">오늘</span>
          </button>
        </div>
      )}
